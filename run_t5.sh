...
python hybrid_model.py \
    -do_abstraction 0 -train_abs 0 -gen_summaries 0 -do_evaluation 1 \
    ...
    -report_every 1 -save_checkpoint_steps 1000 \
    ...
    -abs_learning_rate 1e-4 -abs_batch_size 5 -abs_num_beams 2 \
